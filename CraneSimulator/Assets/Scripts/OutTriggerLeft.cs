...
public class OutTriggerLeft : MonoBehaviour
{
    [Header("References")]
    public Transform arm; // Assign OutTrigger_Left
    public Transform leg; // Assign OutTrigger_Left_Leg
    ...
    [Header("Key Controls")]
    public KeyCode extendKey = KeyCode.Z;
    public KeyCode retractKey = KeyCode.X;
